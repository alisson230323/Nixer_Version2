...
<body>
  ...
  // Obtener los nombres de archivo de las imágenes de la base de datos
  $sql = "SELECT imagen FROM peliculas_series";
  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      $fileName = $row['imagen'];
      echo '<a href="#"><img src="' . $fileName . '" alt="img" draggable="false"></a>';
    }
  } else {
    echo "<p>No se encontraron imágenes en la base de datos.</p>";
  }
